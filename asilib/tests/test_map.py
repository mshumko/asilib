...
@matplotlib.testing.decorators.image_comparison(baseline_images=['test_create_map_equal_subplots'], 
    tol=10, remove_text=True, extensions=['png'])
...
@matplotlib.testing.decorators.image_comparison(baseline_images=['test_create_map_unequal_subplots'], 
    tol=10, remove_text=True, extensions=['png'])
...
@matplotlib.testing.decorators.image_comparison(baseline_images=['test_create_map_gridspec'], 
    tol=10, remove_text=True, extensions=['png'])
