...
ax[0,1] = asilib.map.create_map(lon_bounds=lon_bounds, lat_bounds=lat_bounds, fig_ax=(fig, gs[0,1]))
ax[1,1] = asilib.map.create_map(lon_bounds=lon_bounds, lat_bounds=lat_bounds, fig_ax=(fig, gs[1,1]))
bx = plt.subplot(gs[2,:])
# cx = plt.subplot(gs[3,:])
