...
A ubiquitous way to visualize ASI images and identify different types of aurora is with keograms---an image of pixel intensity as a function of latitude and time. It is assembled by slicing and concatenating pixels that are oriented North-South through zenith (or through a custom path such a path of a stellite) in each image.
